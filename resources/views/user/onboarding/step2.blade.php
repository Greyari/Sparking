    ...
    <div class="bg-white rounded-2xl shadow-xl overflow-hidden w-full max-w-md transform transition-all duration-500 hover:scale-[1.02]">
        ...
        <div class="px-8 pt-8 text-center">
            <div class="w-40 h-40 mx-auto mb-6 animate-wiggle">
                <img src="{{ asset('img/Onboarding/step2.png') }}" alt="Select User Type" class="w-full h-full object-contain scale-125">
            </div>
            <h2 class="text-3xl font-bold text-gray-800 mb-2 animate-fade-in-down">Foto Wajah</h2>
            <p class="text-gray-600 animate-fade-in-down delay-100">Silakan unggah foto wajah Anda dengan jelas</p>
        </div>
            ...
            <div class="relative group animate-fade-in-down delay-300">
                ...
                <label for="foto_user" class="block cursor-pointer">
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center transition-all duration-300 hover:border-blue-400 hover:bg-blue-50 group-hover:shadow-md">
                        ...
                        <p class="text-sm text-gray-500 group-hover:text-gray-700 transition-colors">Klik untuk upload foto wajah</p>
