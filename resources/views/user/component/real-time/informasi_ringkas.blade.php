                    ...
                    <div class="relative z-10">
                        ...
                        <div class="mt-4 pt-3 border-t border-white border-opacity-30">
                            <button
                                ...
                                <span id="btn-notif-text-{{ $zone->id }}"><i class="fas fa-bell mr-1"></i> Beritahu Saya</span>
                            </button>
                        </div>
                        @endauth
...
<script>
    ...
    function updateTombolNotifikasi(zonaId, terdaftar) {
        ...
        if (terdaftar) {
            text.innerHTML = `<i class="fas fa-bell-slash mr-1"></i> Notifikasi Aktif`;
        } else {
            text.innerHTML = `<i class="fas fa-bell mr-1"></i> Beritahu Saya`;
        }
    }
